"""
Django settings for ai_fitness_track_44123 project.
...
ROOT_URLCONF = 'ai_fitness_track_44123.urls'
...
WSGI_APPLICATION = 'ai_fitness_track_44123.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_fitness_track_44123 API",
    "DESCRIPTION": "API documentation for ai_fitness_track_44123 App",
    "VERSION": "v1",
}
